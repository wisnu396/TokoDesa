...
@section('content')
    ...
    <img style="height: 600px;" class="for-contac-image" src="{{asset('public/assets/front-end/img/contact.jpeg')}}" alt="">
</div>
                        ...
                        <div class="row">
                          <div class="col-sm-6">
                              <div class="form-group">
                                ...
                                <input class="form-control name" name="name" type="text" placeholder="Masukkan Nama Anda" required>
                          ...
                          <div class="col-sm-6">
                              <div class="form-group">
                                ...
                                <input class="form-control email" name="email" type="email" placeholder="Contoh@email.com" required >
