<style>
    ...
    @media (min-width: 992px) {
        .y.navbar-stuck .navbar-stuck-menu.show {
            display: block;
...
<header class="box-shadow-sm rtl " >
    ...
    <div class="navbar-sticky mobile-head" style="background: linear-gradient(to bottom, #246c2f, #ffffff);">
        ...
        <a class="navbar-brand d-none d-sm-block {{ Session::get('direction') === 'rtl' ? 'ml-3' : 'mr-3' }} flex-shrink-0"
            ...
            <img width="250" style="height: 60px!important;"
                ...
                onerror="this.src='{{ asset('public/assets/front-end/img/logo1.png') }}'"
